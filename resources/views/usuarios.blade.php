        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <form method="POST" id="registerForm">
              ...
              <label for="rolInput" class="col-md-4 col-form-label text-md-right">Roles</label>

              <div class="col-md-6">

                    <select id="rolInput" class="form-control" placeholder="roles">

                      <option value="todos">Ver roles</option>

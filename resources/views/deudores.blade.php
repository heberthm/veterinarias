    ...
    ====================================== -->
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <table id="table_listado_deudores" class="table dt-responsive table-hover"
                    ...
                    $('body').on('click', '.editarLibroDiario', function(e) {
                        ...
                        $.ajax({
                            ...
                            success: function(data) {
                                ...
                                $('#modalEditarRegistro input[name="descripcion"]').val(data
                                    .descripcion);
                                $('#modalEditarRegistro input[name="responsable"]').val(data
                                    .responsable);
                            ...
                            if (e.value === true) {
                                ...
                                $.ajax({
                                    ...
                                    success: function(data) {
                                        ...
                                        swal("Datos del profesional eliminados correctamente!",

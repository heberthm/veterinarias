...
@section('content')
            ...
            <section class="col-lg-7">
                ...
                <div class="card card-light">
                    <div class="card-header">
                        ...
                        <span class="btn-group float-right" id="btn_listadoClientes">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                <a class="dropdown-item" data-target="#modalVerListadoClientes" data-toggle="modal"
                                    class="MainNavText" id="MainNavHelp" href="#modalVerListadoClientes">Ver listado de
                                    clientes</a>
                            </div>
                        </span>
                    ...
                    <div class="card-body">
                        ...
                        <button class="btn btn-primary" data-toggle="modal" id="agregar_cliente_nuevo"
                            data-target="#modalAgregarCliente" style="text-align:left"><span class="fa fa-user fa-fw"
                                tabindex="3"></span> Agregar cliente nuevo</button>
                    </div>
                </div>
                <!-- /.card-body -->
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="listado_citas">
                                        <div class="form-group">
                                            <table id="Table_listado_cumpleaños" class="table dt-responsive table-hover"
                ...
                <div class="card" style="height:97%">
                    ...
                    <div class="card card-light">
                        ...
                        <div class="card-header">
                            ...
                            <h3 class="card-title"><span style="color: #28a745;" class="fas fa-calendar mr-3"></span>Agenda
                                de citas</h3>
            ...
            <div class="modal-dialog" role="document">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        ...
                        <h5 class="modal-title"><span style="color:#28a745;"
                                class="fas fa-calendar mr-3"></span>Calendario citas</h5>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-5">
                                ...
                                <input id="filtrar_calendario" name="filtrar_calendario" type="text"
                                    class="form-control form-control" placeholder="Filtrar eventos">
        ...
        <div class="modal-dialog modal-lg">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header">
                    ...
                    <h5 class="modal-title"><span style="color:#28a745;" class="fas fa-edit mr-3"></span>Agendar citas
                    </h5>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <label for="title" class="control-label">Cliente &nbsp;
                                        ...
                                        <span class="btn-group float-right" id="btn_historialIngresos">
                                            ...
                                            <a href="#" class="mr-3" data-toggle="modal"
                                                data-target="#modalAgregarCliente2"><i class="fas fa-user-plus"
                                                    style="color: #1566EB;" title="Agregar nuevo cliente"></i></a>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="livesearch2 form-control" id="livesearch2" name="nombre_cliente"
                                            style="width: 100%;"></select>

                                    </div>


                                    <input type="hidden" name="cliente" class="form-control text-capitalize"
                                        id="cliente">
                  ...
                  -->
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="tel" name="telefono" class="form-control text-capitalize"
                                        id="celular_cliente" required onkeypress="return isNumber(event)">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="medico" class="form-control" id="medico" required
                                        ...
                                        <option value="" selected="selected" style='color: #cccccc'>Seleccionar
                                            médico</option>
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="servicios2" name="servicios2" class="form-control"
    ...
    @endforeach
                   ...
                   -->
                            ...
                            <div class="col-md-2">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="color" id="color" name="color" list="ListadoColores"
                                        value="#1560F6" class="form-control" required autocomplete="off">
       ...
       -->
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" id="agregar_cita" name="agregar_cita"
        ...
        <div class="modal-dialog modal-lg">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header">
                    ...
                    <h5 class="modal-title"><span style="color:#28a745;" class="fas fa-edit mr-3"></span>Editar citas
                    </h5>
                ...
                <div class="modal-body">
                    ...
                    <form method="GET" id="editar_calendario"
                        action="{{ url('fullcalendareventmaster/Update_event/id') }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-8">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="cliente" class="form-control text-capitalize"
                                        id="cliente" maxlength="35" autofocus required autocomplete="off">
                            ...
                            <div class="col-lg-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="telefono" class="form-control text-capitalize"
                                        id="telefono" required onkeypress="return isNumber(event)">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="servicios" name="servicios" value="#1560F6"
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="color" id="color2" name="color2" list="ListadoColores"
                                        value="#1560F6" class="form-control" required autocomplete="off">
    ...
    -->
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" id="eliminar_evento" name="eliminar_evento"
                                class="btn btn-outline-danger elminar_evento mr-auto">Eliminar cita</button>

                            <button type="submit" id="Editar_cita" name="Editar_cita"
                                class="btn btn-primary">Guardar</button>
                            <button type="button" id="salir" class="btn btn-secondary"
                                data-dismiss="modal">Cerrar</button>
        ...
        <div class="modal-dialog modal-lg">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header">
                    ...
                    <h5 class="modal-title"><span style="color:#28a745;" class="fas fa-user mr-3"></span>Agregar cliente
                    </h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="cedula" class="form-control" id="cedula" autofocus
                                        required autocomplete="off">
                                ...
                                <div class="form-group">
                                    ...
                                    <div id="fechaNacimiento" class="input-group date enddate">
                                        ...
                                        <input type="text" name="nombre" class="form-control text-capitalize"
                                            id="nombre_cliente" required autocomplete="off">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="celular" class="form-control" id="celular_cliente"
                                        required autocomplete="off">
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" name="fecha_nacimiento1"
                                        id="fecha_nacimiento1" required />
                            ...
                            <input type="hidden" class="form-control" name="fecha_nacimiento" id="fecha_nacimiento"
                                required />
                            ...
                            <div class="col-md-7">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="direccion" class="form-control text-capitalize"
                                        id="direccion" required onkeypress="return isNumber(event)">
    ...
    -->
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" id="agregar_cliente" name="agregar_cliente"
                                class="btn btn-primary loader">Guardar</button>
                            <button type="button" id="salir" class="btn btn-secondary"
                                data-dismiss="modal">Cerrar</button>
    ...
    <div class="modal fade" id="modalAgregarCliente2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="cedula2" class="form-control" id="cedula2" autofocus
                                        required autocomplete="off">
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" name="fecha_nacimiento2"
                                        id="fecha_nacimiento2" required />
                            ...
                            <input type="hidden" class="form-control" name="fecha_nacimientos" id="fecha_nacimientos"
                                required />
                            ...
                            <div class="col-md-2">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="edad2" name="edad2" required
                                        autocomplete="off">
    ...
    -->
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" id="agregar_cliente2" name="agregar_cliente2"
                                class="btn btn-primary loader">Guardar</button>
                            <button type="button" id="salir" class="btn btn-secondary"
                                data-dismiss="modal">Cerrar</button>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header">
                    ...
                    <h5 class="modal-title"><span style="color:#28a745;" class="fas fa-user mr-3"></span>Agregar a lista
                        de espera</h5>
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="selectBuscarCliente" name="selectBuscarCliente"
                                        id="selectBuscarCliente" style="width:100%;" required> </select>
                            ...
                            <div class="col-6">
                                ...
                                <div class="form-group BuscMascota" style="display:none;">
                                    ...
                                    <select class="form-control" name="buscarMascota" id="buscarMascota"
                ...
                <input type="hidden" name="nombre_Mascota" class="form-control" id="nombre_Mascota"
                    autocomplete="off">
                ...
                <div class="form-group especie" style="display:none;">
                    <select class="form-control  buscarEspecie" name="buscarEspecie" id="buscarEspecie"
                        style="width:100%;" required>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" id="agregar_lista_espera" name="agregar_lista_espera"
                        class="btn btn-primary">Guardar</button>
                    <button type="button" id="salir" class="btn btn-secondary salir"
                        data-dismiss="modal">Cerrar</button>
    ...
    <div class="modal fade modal-fullscreen" id="modalVerListadoClientes" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-xl role=" document">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header">
                    ...
                    <h5 class="modal-title"><span style="color:#28a745;" class="fas fa-users mr-3"></span>Listado de
                        clientes</h5>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($clientes as $cliente)
                                        <tr>
                                            ...
                                            <td align="center">
                                                <input data-id="{{ $cliente->id_cliente }}" class="switch"
                                                    type="checkbox" data-size="xs"
        ...
        <script>
            ...
            $(document).ready(function() {
                ...
                function getlist_calendartipos() {
                    let list = ['auriculoterapia', 'biomagnetismo', 'colonterapia', 'colonterapia - lodoterapia',
                        'control', 'drenaje',
                ...
                let tribute = new Tribute({
                    ...
                    menuItemTemplate: function(item) {
                        ...
                        return item.string + ' <i style="color:' + color +
                            ';" class="fas fa-circle ml-2"></i>';
                    },
                    ...
                    success: function(data) {
                        ...
                        if (data.length > 0) {
                            ...
                            $.each(data, function(key, value) {
                                $('#buscarMascota').append('<option value="' + value.id + '">' +
                                    value.nombre + ' - ' + value.especie + ' </option>');
                            ...
                            $.each(data, function(key, value) {
                                $('#buscarEspecie').append('<option value="' + value.especie +
                                    '">' + value.especie + '</option>');
                    ...
                    eventAfterRender: function(event, element) {
                        ...
                        element.popover({
                            ...
                            content: '<p>' + 'Teléfono: ' +
                                ...
                                event.telefono + '<p>' + 'Asignado a: ' + event.medico + '<p>' +
            ...
            $(document).ready(function() {
                ...
                let calendar = $('#calendar2').fullCalendar({
                    ...
                    eventRender: function(event, element, view) {
                        ...
                        return ['todos', event.medico].indexOf($('#selector').val()) >= 0 && ['', event
                            .title
                        ].indexOf($('#filtrar_calendario').val()) >= 0;
            ...
            $(document).ready(function() {
                ...
                $('#cedula').blur(function() {
                    ...
                    if (!filter.test(cedula)) {
                        ...
                        $('#error_cedula').html(
                            '<label class="text-danger">Debe escribir número de cédula.</label>');
                        ...
                        $.ajax({
                            ...
                            success: function(result) {
                                ...
                                if (result == 'unique') {
                                    ...
                                    $('#error_cedula').html(
                                        '<label class="text-danger">El cliente ya existe.</label>'
                                        );
                        ...
                        $.ajax({
                            ...
                            success: function(data) {
                                ...
                                $.each(data, function(key, value) {
                                    ...
                                    $('#buscarEspecie').append('<option value="' + value
                                        .especie + '">' + value.especie + '</option>');
